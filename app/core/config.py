...
class Settings(BaseSettings):
    ...
    app_name: str = Field(
        default="travel-assistant", description="Application display name."
    )
    ...
    postgres_host: str = Field(
        default="127.0.0.1", description="PostgreSQL server host."
    )
